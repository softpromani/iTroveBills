        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
                ...
                <div class="flex space-x-6 mt-4 md:mt-0">
                    <Link :href="route('privacy.policy')" class="text-gray-400 hover:text-white text-sm transition-colors">Privacy Policy</Link>
                    <Link :href="route('terms.service')" class="text-gray-400 hover:text-white text-sm transition-colors">Terms of Service</Link>
                    <Link :href="route('cookie.policy')" class="text-gray-400 hover:text-white text-sm transition-colors">Cookie Policy</Link>
                </div>
            </div>
        </div>
    </footer>
