            ...
            <div class="row">
                ...
                <form @submit.prevent="submit">
                    <div class="row">
                        ...
                        <div class="mt-3 col-md-6">
                            <InputLabel for="gst" value="GST/VAT/TIN" />
                            <TextInput
                                id="gst"
                                type="text"
                                class="block w-full mt-1"
                        ...
                        <div class="pt-4 mt-2 col-md-12">
                            <div
                                v-for="item in inv_tax_type"
                                :key="item.id"
                    ...
                    <div
                        class="flex flex-col items-end mt-4 col-md-12 justify-content-center align-items-center"
                    >
                        <PrimaryButton
                            class="w-full col-md-6"
...
const submit = () => {
    form.post(route("register"), {
        onFinish: () => form.reset("password", "password_confirmation", "gst"),
    });
};
</script>
