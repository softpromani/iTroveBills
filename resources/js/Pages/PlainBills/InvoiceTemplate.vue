        ...
        <div class="invoice-container shadow-sm mx-auto bg-white border-2 border-dark">
                    ...
                    <div class="d-flex align-items-start mb-2">
                        ...
                        <div>
                            ...
                            <div class="address-box details-text">
                                N.S. Road, Jaigaon, Alipurduar, West Bengal, Pin - 736182
            ...
            <div class="item-table-container">
                <table class="table border-0 mb-0 item-table">
                    ...
                    <tbody>
                        <tr v-for="(item, index) in props.invoice.items" :key="item.id" class="item-row">
            ...
            <div class="row no-gutters border-top border-dark">
                ...
                <div class="col-7 border-right border-dark p-3 x-small">
                    <div class="row no-gutters mb-3 bank-details">
                        ...
                        <div class="col-8">: <strong>Union Bank of India</strong></div>
                ...
                <div class="col-5 p-2 text-right d-flex flex-column justify-content-between min-vh-15">
                    <div class="small font-weight-bold text-center">for CHOICE ENTERPRISE</div>
...
const calculateTotalQty = () => {
    return props.invoice.items?.reduce((sum, item) => sum + parseFloat(item.quantity || 0), 0) || 0;
};
