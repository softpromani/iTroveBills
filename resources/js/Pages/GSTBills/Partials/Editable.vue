...
const handleTabNavigation = (event, rowIndex, currentField) => {
    ...
    const fieldOrder = ['description', 'hsn', 'quantity', 'unit', 'weight', 'rate', 'gst-percentage', 'gst-amount'];
    const currentFieldIndex = fieldOrder.indexOf(fieldOrder[currentField]);
