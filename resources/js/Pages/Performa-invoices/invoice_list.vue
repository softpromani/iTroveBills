<template>
    ...
    <AuthenticatedLayout>
        <div
            class="inline-flex w-full mb-4 overflow-hidden bg-white rounded-lg shadow-md justify-between items-center pr-4"
        >
            <div class="flex items-center">
                <div class="flex items-center justify-center w-12 h-12 bg-pink-800">
                    <svg
